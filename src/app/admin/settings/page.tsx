...
export default function AdminSettingsPage() {
  ...
  const [settings, setSettings] = useState({
    ...
    email: 'info@webotixs.com',
    phone: '+1 (208) 905-5973',
    address: 'Mz floor, Al-Qadir Heights, Kalma Chowk Flyover، Babar Block Garden Town, Lahore, 54000, Pakistan',
    whatsapp: '+923092715559',
    // Social
    ...
    sender_email: 'info@webotixs.com',
    notification_email: 'info@webotixs.com',
    // Legal Policies
